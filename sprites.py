...
class Player(pygame.sprite.Sprite):
    '''player sprite'''
    def __init__(self, name, prev_player=None):
        ...
        self.__sprites=[[[[pygame.image.load('images/player/'+str(orientation)+'/'+str(weapon)+'/'+str(animation)+'/'+str(frame)+'.png').convert_alpha() for frame in range(len(os.listdir('images/player/'+str(orientation)+'/'+str(weapon)+'/'+str(animation)))-1)] for animation in range(len(os.listdir('images/player/'+str(orientation)+'/'+str(weapon))))] for weapon in range(2)] for orientation in range(2)]  
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self,midbottom, num):
...
class Tank(pygame.sprite.Sprite):
    ...
    def __init__(self,prev_tank=None):
        ...
        self.__sprites=[[pygame.image.load('images/tank/'+str(animation)+'/'+str(frame)+'.png').convert_alpha() for frame in range(len(os.listdir('images/tank/'+str(animation))))] for animation in range(5)]         
        #loads mg turret image
        self.__mg=pygame.image.load('images/tank/turret.png').convert_alpha() 

        # the occupation of tank
    ...
    def get_occupation(self):
        '''get the occupation of the tank'''
        return self.__occupied
        
    def set_occupation(self):
        '''set the occupation of the tank'''
...
class Info(pygame.sprite.Sprite):
    ...
    def __init__(self, info):
        ...
        self.rect=self.image.get_rect()              
        self.rect.center=(480, 400)
        self.__type = 0

    def update(self):
        '''update method'''
        # change the color during the waiting time
        self.__type += 1
        self.image=self.__font.render(self.__text,True,((255,255,255),(174,238,238))[self.__type%2])      
...
class Boss(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        #loads image and rect
        self.__sprites=[pygame.image.load('images/boss/tank'+str(i)+'.png').convert_alpha() for i in range(2)]
        self.__explosion=[pygame.image.load('images/tank/4/'+str(i)+'.png').convert_alpha() for i in range(17,42)]
